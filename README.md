...
Short-stay rental price prediction using linear regression in R. Built as a DataCamp certification case study for Inn the Neighborhood, a fictional property rental platform.
